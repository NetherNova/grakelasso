                    ...
                    for length in [5, 10, 20]:
                        ...
                        for k in xrange(0, k_fold):
                            ...
                            for class_index in xrange(num_classes):
                                ...
                                # TODO: evaluate constraints only for current class label! (look in label_mappings, if this instance has the current label.
                        ...
                        if c:
                            ...
                            model_name = m
                        writer.writerow([length, np.average(scores), model_name, np.average(times), names[i]])
                        print(scores)
